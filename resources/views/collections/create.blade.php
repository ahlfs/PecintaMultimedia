...
@section('title', 'Buat Koleksi Baru - GudangMeme')
...
<div class="relative min-h-[calc(100vh-140px)] py-12 px-4 sm:px-6 lg:px-8 bg-slate-50">
    ...
    <div class="max-w-2xl mx-auto z-10 relative animate-fade-in-up">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                <h1 class="text-3xl font-extrabold bg-gradient-to-br from-[#e69b00] via-[#e6b400] to-[#e6cc00] bg-clip-text text-transparent tracking-tight">Buat Koleksi Baru</h1>
                <p class="text-slate-500 text-sm mt-0.5">Kelompokkan visual meme, ide-ide kreatif, dan foto favorit Anda.</p>
            </div>
        </div>
