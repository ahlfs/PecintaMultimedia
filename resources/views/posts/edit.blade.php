...
<div class="relative min-h-[calc(100vh-140px)] py-12 px-4 sm:px-6 lg:px-8 bg-slate-50">
    ...
    <div class="max-w-3xl mx-auto z-10 relative animate-fade-in-up">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                <h1 class="text-3xl font-extrabold bg-gradient-to-br from-[#e69b00] via-[#e6b400] to-[#e6cc00] bg-clip-text text-transparent tracking-tight">Edit Postingan</h1>
            ...
            <form action="{{ route('posts.update', $post->slug) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="border border-slate-200 rounded-3xl p-4 bg-gradient-to-b from-amber-50/30 to-white text-center flex flex-col items-center justify-center hover:shadow-[0_4px_20px_rgba(230,155,0,0.08)] transition-all duration-300">
                        ...
                        <div id="dropzone" class="relative border-2 border-dashed border-slate-300 hover:border-[#e6b400] rounded-3xl p-4 text-center transition-all bg-slate-50/50 hover:bg-white flex flex-col items-center justify-center min-h-[180px] group @error('image') border-red-300 bg-red-50/10 @enderror">
                            ...
                            <div id="image-preview-container" class="hidden w-full max-h-[160px] overflow-hidden rounded-xl relative">
                                ...
                                <button
                                    ...
                                    class="absolute top-2 right-2 w-7 h-7 rounded-full bg-black/60 hover:bg-black text-white flex items-center justify-center transition-all z-20 hover:scale-110"
                                    title="Hapus Gambar"
                                >
                            ...
                            <div id="upload-prompt" class="flex flex-col items-center justify-center">
                                <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-[#e69b00]/20 to-[#e6b400]/20 text-[#e69b00] flex items-center justify-center mb-2 group-hover:scale-110 group-hover:shadow-[0_0_30px_rgba(230,155,0,0.3)] transition-all">
