...
<div class="relative min-h-[calc(100vh-140px)] py-12 px-4 sm:px-6 lg:px-8 bg-slate-50">
    ...
    <div class="max-w-3xl mx-auto z-10 relative animate-fade-in-up">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                <h1 class="text-3xl font-extrabold text-brand-primary tracking-tight">Unggah Meme Baru</h1>
        ...
        <div class="bg-white rounded-3xl border border-slate-100 shadow-xl overflow-hidden p-8 sm:p-10">
            <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <div id="dropzone" class="relative border-2 border-dashed border-slate-300 hover:border-brand-accent rounded-3xl p-8 text-center transition-all bg-slate-50/50 hover:bg-white flex flex-col items-center justify-center min-h-[220px] group @error('image') border-red-300 bg-red-50/10 @enderror">
                        <input 
                            type="file" 
                            id="image" 
                            name="image" 
                        ...
                        <div id="image-preview-container" class="hidden w-full max-h-[300px] overflow-hidden rounded-2xl relative">
                            ...
                            <button 
                                ...
                                class="absolute top-3 right-3 w-8 h-8 rounded-full bg-black/60 hover:bg-black text-white flex items-center justify-center transition-all z-20"
                                title="Hapus Gambar"
                            >
                        ...
                        <div id="upload-prompt" class="flex flex-col items-center justify-center">
                            <div class="w-16 h-16 rounded-2xl bg-brand-primary/10 text-brand-primary flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
